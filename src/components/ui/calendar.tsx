  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground w-9 h-9 text-center text-[0.75rem] font-medium tracking-wide",
        ...
        day_range_start: "day-range-start aria-selected:bg-app-primary aria-selected:text-primary-foreground",
        day_range_end: "day-range-end aria-selected:bg-app-primary aria-selected:text-primary-foreground",
        day_selected:
